...
export const demoFlashcards: Flashcard[] = [
  { id: "f1", subjectId: "bio", front: "What is the powerhouse of the cell?", back: "The mitochondria — it produces ATP through cellular respiration." },
  { id: "f2", subjectId: "bio", front: "Define photosynthesis", back: "The process by which plants convert light energy, water, and CO₂ into glucose and oxygen." },
  { id: "f3", subjectId: "math", front: "Quadratic formula", back: "x = (-b ± √(b² − 4ac)) / 2a" },
];
